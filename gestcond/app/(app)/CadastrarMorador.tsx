...
export default function CadastrarMoradorScreen() {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Tela de Cadastrar Morador</Text>
      <Text style={styles.subtitle}>Formulário para administradores registrarem novos moradores.</Text>
      
      {/* Botão de Voltar */}
      <TouchableOpacity 
        style={styles.backButton} 
        onPress={() => router.back()} // Volta para a tela anterior (Home/Dashboard)
      >
