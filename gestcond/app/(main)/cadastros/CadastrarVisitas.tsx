// app/(main)/cadastro/CadastrarVisitas.tsx
  ...
  const handleRegisterVisit = async () => {
    ...
    try {
      ...
      const response = await api.post('/api/visitors', { 
        name: visitorName,
        cpf: visitorCpf,
        apartmentBlock: aptBlockVisited, 
        visitDate: visitDate, 
        visitTime: visitTime, 
      });
...
const styles = StyleSheet.create({
  ...
  button: {
    width: '100%', backgroundColor: '#20B2AA', // Verde mar
